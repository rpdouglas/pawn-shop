...
+             "id": "color-contrast",
+             "impact": "serious",
+             "message": "Element has insufficient color contrast of 2.86 (foreground color: #1a0d2e, background color: #764c9a, font size: 13.5pt (18px), font weight: normal). Expected contrast ratio of 4.5:1",
+             "relatedNodes": Array [
+               Object {
...
+         ],
+         "failureSummary": "Fix any of the following:
+   Element has insufficient color contrast of 2.86 (foreground color: #1a0d2e, background color: #764c9a, font size: 13.5pt (18px), font weight: normal). Expected contrast ratio of 4.5:1",
+         "html": "<button class=\"btn btn-primary btn-lg\" aria-label=\"I confirm I am 19 or older\">I am 19 or older</button>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
