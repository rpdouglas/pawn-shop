...
The **Inventory Management** page (`/admin/inventory`) is the central hub for overseeing all items across The Pawn Shop's three storefronts.
...
Select any row in the table to open the **AI Assistant Toolkit** for that item. From here, you can:
