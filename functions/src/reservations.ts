...
export const createReservation = onCall<CreateReservationData>({ cors: true }, async (request) => {
...
export const confirmReservation = onCall<ConfirmReservationData>({ cors: true }, async (request) => {
